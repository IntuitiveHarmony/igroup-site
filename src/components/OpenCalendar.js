      ...
      return (
        <div className="calendarContainer" id="calendar">
          <div className="circleContentContainer">
            <h1 className="circleHeader">Open Circles</h1>
