...
const OpenCalendar = () => {
      ...
      return (
        <div className="calendarContainer" id="calendar">
          ...
          <p className="content">Therefore, it is imperative that we know of your intended attendance and are confident of your cooperation in keeping with our standards of conduct by completing our <a href='https://docs.google.com/document/d/0B-brdUxbCO3xN2lsOTA3RG05eFRrVlowLWcxbGFRTW81d3hJ/edit?resourcekey=0-BHJGs9Y_JiDMkzftJWv1qQ' target="_blank" rel="noopener noreferrer">Rules and Guidelines</a> form (linked below). If you plan to attend, send us notice at least 24 hours in advance of an Open Circle date via email, or our mobile chat app, Discord (which is our preferred mode of communication).</p>
